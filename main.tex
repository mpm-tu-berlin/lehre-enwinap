...
\begin{framed}
Dir Lernjournalsbewertung wird blind durchgeführt, d.\ h. die Bewertenden kennen die Identität der Studierenden nicht. Aus diesem Grund darf die Matrikelnummmer sowie der Name \emph{nicht} im Dokument enthalten sein. Die Identifizierung erfolgt über ISIS.
\end{framed}
...
vor allem eigene Einschätzungen und Interpretationen der Inhalte vermerkt
werden. Dabei soll sich die \textbf{Reproduktion der Inhalte auf ein Minimum
...
Wir erwarten einen \emph{Umfang} von einer A4-Seite (oder dem
...
Die Nutzung von generativer künstlicher Intelligenz (KI) im Lernjournal ist gestattet, jedoch nicht notwendig. Sollte generative KI genutzt werden, ist dies \textbf{anzugeben} und verpflichtend \textbf{der "`Prompt"' bzw. ein Transkript der Konversation mit der KI} beizufügen (z.B. in einem Anhang, der selbstverständlich nicht auf die Seitenzahl angerechnet wird).
